<template>
    <section>
        ...
        <article :id='id_article'>
            <div class="top">
                <div class="nom" :data-id='id_compte'><img :src="'/img/'+avatar" alt='avatar' title='avatar'/>{{ nom_auteur }}</div>
        ...
        <div v-for="item in commentaires" :key="item" :data-id='item.id_commentaire' class="commentaire">
            <div class="top">
                <div class="nom" :data-id='item.id_compte'><img :src="'/img/'+item.avatar" alt='avatar' title='avatar'/>{{ item.nom }}</div>
...
data() {
  return {message:'',
        ...
        avatar:'photo-profil.406065ea.png',
        nom_auteur:'Jean Pierre',
        date:1642519961000,
        ...
        likes:25,
        dislikes:9,
        commentaires:[{id_commentaire:'1902859275',id_compte:'69838134165',avatar:'photo-profil.406065ea.png',nom:'Martin Dupont',date:1642595037324,message:'ce chat est vraiment très drôle !',likes:3,dislikes:0},
                    {id_commentaire:'1092859232',id_compte:'69838198023',avatar:'photo-profil.406065ea.png',nom:'Stéphane Ny',date:1592859232564,message:'oui',likes:11,dislikes:2},
                    {id_commentaire:'1786943823',id_compte:'69838187125',avatar:'photo-profil.406065ea.png',nom:'Antoine Cétoine',date:1596943823132,message:'J\'ai rigolé XD',likes:1,dislikes:0}]}
},
methods: {
        comment() {
